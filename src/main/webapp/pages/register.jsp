...
<head>
    ...
    <title>注册管理员页面</title>
    <meta name="description" content="注册管理员页面">
    <meta name="keywords" content="注册管理员页面">
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                注册管理员 <small>账号</small>
            </h1>
        </section>
        <!-- 内容头部 /-->

        <form action="${pageContext.request.contextPath}/userInfo/save.do" method="post">
            <!-- 正文区域 -->
            <section class="content"> <!--产品信息-->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-2 title rowHeight">密码</div>
                        <div class="col-md data rowHeight">
                            <input type="text" class="form-control" name="password">
                        </div>
                        <div class="col-md-2 title rowHeight">姓名</div>
                        <div class="col-md data rowHeight">
